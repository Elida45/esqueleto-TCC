...
% Informações de dados para CAPA e FOLHA DE ROSTO
	\titulo{PROPIEDADES DA MADEIRA DE PINUS CARIBACEA EUCALYPTUS GRANDIS ESTIMADAS POR COLORIMETRIA}
\autor{Élida Caroline Martins de Souza}
\local{Maceió, Alagoas}
\data{2022}
\orientador{Profa. Dra. Silvana Gonsalves}
\coorientador{Prof. Dr. Fernando Lima}
